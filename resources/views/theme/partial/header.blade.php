        ...
        <div class="container box_1620">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            ...
            <ul class="nav navbar-nav menu_nav justify-content-center">
              <li class="nav-item @yield('home-active')"><a class="nav-link" href="{{route('index')}}">Home</a></li>
              <li class="nav-item @yield('category-active') submenu dropdown">
               ...
               <ul class="dropdown-menu">
                ...
                <li class="nav-item"><a class="nav-link" href="{{route('category' , ['id' => $category->id])}}">{{$category->name}}</a></li>
                @endforeach
              </ul>
               @endif
              </li>
              <li class="nav-item @yield('contact-active')"><a class="nav-link " href="{{route('contact')}}">Contact</a></li>
            </ul>
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="nav-item">
                        <form id="logout" action="{{route('logout')}}" method="post">
                            @csrf
                            <a class="nav-link" href="javascript:$('form#logout').submit();">Logout</a>
