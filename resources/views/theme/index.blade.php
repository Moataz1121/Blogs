          ...
          <div class="owl-carousel owl-theme blog-slider">
            @foreach ($slider as $blog)
             <div class="card blog__slide text-center">
              ...
              <img height="180px" class="card-img rounded-0" src="{{asset("storage/blogs/$blog->image") }}" alt="">
              </div>
              <div class="blog__slide__content">
              <a class="blog__slide__label" href="{{route('category' , ['id' => $blog->category->id])}}">{{$blog->category->name}}</a>
