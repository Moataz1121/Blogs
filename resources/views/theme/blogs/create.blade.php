      ...
      <div class="row">
        ...
        @endif
         ...
         <div class="form-group">
            <input class="form-control border" name="name" value="{{old('name')}}" type="text" placeholder="Enter your Blogs">
          ...
          <div class="form-group">
            <textarea class="w-100 border" row(5) name="description"value = {{old('description')}} placeholder="Enter your Message"></textarea>
